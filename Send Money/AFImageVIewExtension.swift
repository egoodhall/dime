...
public extension UIImageView {
    ...
    - Parameter fadeIn :Bool Weather the mage should fade in.
    - Parameter closure :(image: UIImage?) The image from the web the first time is fetched.
    
    - Returns: UIImage?
    - If cached, the cached image is returned. Otherwise, a place holder is used until the image from web is returned by the closure.
    */
