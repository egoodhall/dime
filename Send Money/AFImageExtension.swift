...
public extension UIImage {
    ...
    */
    ...
    - Parameter color :UIColor The color to fill the image with.
    - Parameter size :CGSize Image size (defaults: 10x10)
    ...
    */
    ...
    - Parameter gradientColors :[UIColor] The colors to use for the gradient.
    - Parameter size :CGSize Image size (defaults: 10x10)
    ...
    */
    ...
    - Parameter gradientColors :[UIColor] The colors to use for the gradient.
    - Parameter blendMode :CGBlendMode The blending type to use.
    ...
    */
    ...
    - Parameter text :String The text to use in the label.
    - Parameter font :UIFont The font (default: System font of size 18)
    - Parameter color :UIColor The text color (default: White)
    - Parameter backgroundColor :UIColor The background color (default:Gray).
    - Parameter size :CGSize Image size (default: 10x10)
    - Parameter offset :CGPoint Center offset (default: 0x0)
    ...
    */
    ...
    - Parameter fromView :UIView The source view.
    ...
    */
    ...
    - Parameter startColor :UIColor The start color
    - Parameter endColor :UIColor The end color
    - Parameter radialGradientCenter :CGPoint The gradient center (default:0.5,0.5).
    - Parameter radius :CGPoint Radius size (default: 0.5)
    - Parameter size :CGSize Image size (default: 100x100)
    ...
    */
    ...
    - Parameter padding :CGFloat The padding amount.
    ...
    */
    ...
    - Parameter bounds :CGRect The bounds of the rectangle inside the image.
    ...
    */
    ...
    - Parameter size :CGSize The new size of the image.
    - Parameter contentMode :UIImageContentMode The way to handle the content in the new size.
    ...
    */
    ...
    - Parameter cornerRadius :CGFloat The corner radius.
    ...
    */
    ...
    - Parameter placeholder :UIImage The placeholder image.
    - Parameter shouldCacheImage :Bool Weather or not we should cache the NSURL response (default: true)
    - Parameter closure :(image: UIImage?) The image from the web the first time is fetched.
